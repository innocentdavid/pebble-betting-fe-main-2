    ...
    <div className="bg-[#0D0F11] h-screen overflow-auto md:overflow-hidden">
      <div className="w-full flex flex-col _max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row w-full">
          <div
            className={`${
              !expand ? "w-[18%]" : "_min-w-[80px]"
            } transition-all duration-300 bg-[#16202B05] border-[#68758C25] border hidden md:block h-[calc(100vh-80px)] md:h-[calc(100vh-110px)] remove-scroll overflow-auto relative`}
          >
            {leftSide}
          </div>
          ...
          >
            ...
            <div className="min-w-[329px] h-[calc(100vh-80px)] md:h-[calc(100vh-110px)] overflow-y-auto remove-scroll flex-row gap-5 py-5 px-2">
              {!isMobile && !isAdmin && (
                    ...
                    <aside className="w-full h-full">
                      {isAdmin && (
                        <div className="flex flex-col ml-5">
                          ...
                          ></input>
                          <p className="text-white">
                            {matchId === "bet" ? "Rio de Janeiro" : "Hamster5"}
                          </p>
                          <input
                            type="number"
                            className="py-1 px-2 text-white font-bold text-2xl bg-transparent active:bg-transparent w-16 text-center"
        ...
        <div className="md:hidden h-[70px] py-3 flex flex-col justify-center relative px-2">
