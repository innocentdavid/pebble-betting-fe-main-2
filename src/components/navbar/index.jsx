  ...
  return (
    <>
      ...
      <div
        className={`${
          !expand ? "items-center" : ""
        } transition-all duration-500 flex flex-col py-3 xl:py-[22px] bg-gradient-to-br rounded px-2 lg:px-4 w-full md:gap-y-8 lg:gap-y-[48px] h-full`}
      >
        {expand && (
          <div className="transition-all duration-700 w-full h-auto p-4 border-b border-[#C88300] rounded flex flex-col gap-4 justify-between">
            <div className="rounded-[8px] bg-[#52545A25] px-5 py-2 flex justify-between gap-3 text-base font-semibold">
              <div className="flex items-center">
                <img src="/images/token-icon.svg" width={24} height={24}></img>
                <p className="text-white text-center mx-4">LIVE</p>
              </div>
        ...
        <div className="">
          <div className="pb-6 lg:mb-0 flex justify-between">
            {expand && (
              <div className="flex">
          ...
          {expand && (
            <div
              className="mb-6 lg:mb-0 flex justify-between cursor-pointer"
              onClick={() => {
          ...
          >
            ...
            >
              ...
              />
              {expand && <p className="mx-1">Hamster</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx">Marble Racing</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">Rat roulette</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">Turtle</p>}
            </Button>
          </div>

          <div
            className={`${
              expand ? "mr-10 mt-2 gap-2" : "mt-6 gap-6 items-center"
          ...
          >
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">My Favorites</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">Recent Games</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">Sedona Rooms</p>}
            </Button>
            ...
            >
              <img
                ...
                className={`${expand ? "mx-2 xl:mx-4" : ""}`}
              />
              {expand && <p className="mx-1">Sports</p>}
            </Button>
          </div>
          <div className=""></div>
        </div>
        ...
        <div className="lg:hidden absolute bottom-0 right-3 w-fit flex justify-end">
          <div
            className={`cursor-pointer hover:bg-black p-1 rounded-full mb-6 ${
              expand ? "rotate-180" : ""
            }`}
            onClick={() => {
              setExpand(!expand);
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M19 4.875C19 4.39175 18.6082 4 18.125 4H17.25C16.7668 4 16.375 4.39175 16.375 4.875V15.375C16.375 15.8583 16.7668 16.25 17.25 16.25H18.125C18.6082 16.25 19 15.8583 19 15.375V4.875Z"
                fill="#868DA6"
              />
              <path
                d="M12.0531 5.6212C11.7775 5.3456 11.3062 5.54079 11.3062 5.93057V14.3181C11.3062 14.7079 11.7775 14.9031 12.0531 14.6274L16.2469 10.4337C16.4177 10.2629 16.4177 9.98584 16.2469 9.81495L12.0531 5.6212Z"
                fill="#868DA6"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M4.30469 9.6875C4.30469 9.20424 4.69642 8.8125 5.17969 8.8125H10.4297C10.9129 8.8125 11.3047 9.20424 11.3047 9.6875V10.5625C11.3047 11.0458 10.9129 11.4375 10.4297 11.4375H5.17969C4.69642 11.4375 4.30469 11.0458 4.30469 10.5625V9.6875Z"
                fill="#868DA6"
              />
            </svg>
          </div>
